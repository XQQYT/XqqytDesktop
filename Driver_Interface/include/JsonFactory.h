...
public:
    ...
    virtual bool contain(std::string&& ksssey);
...
public:
    ...
    virtual std::shared_ptr<std::string> ws_sdp_offer(const std::string&& user_id,const std::string&& target_id,const std::string&& sdp);
