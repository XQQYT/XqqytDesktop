...
class PipeWireAudioCapture : public webrtc::AudioDeviceModule, public rtc::RefCountInterface{
public:
    PipeWireAudioCapture(webrtc::AudioDeviceModule::AudioLayer audio_layer,
    ...
    static rtc::scoped_refptr<AudioDeviceModule> Create(
        ...
        webrtc::TaskQueueFactory* task_queue_factory)
        {
            return rtc::scoped_refptr<webrtc::AudioDeviceModule>(
                new rtc::RefCountedObject<PipeWireAudioCapture>(audio_layer, task_queue_factory)
            );
        }
